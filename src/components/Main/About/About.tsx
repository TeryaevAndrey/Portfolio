        ...
        <div className="flex flex-col md:flex-row items-center md:justify-between mt-6 md:mt-12">
          ...
          <div className="flex flex-col text-center md:text-start mt-8 lg:mt-0 max-w-auto md:max-w-[450px] lg:max-w-[500px] w-full">
            <p className="leading-[26px]">
              ...
              совершенствование своих навыков. Я готов работать с вами и внести
              свой вклад в создание потрясающих веб-приложений. Если у вас есть
              какие-либо вопросы или предложения, пожалуйста, не стесняйтесь
              связаться со мной!
            </p>
